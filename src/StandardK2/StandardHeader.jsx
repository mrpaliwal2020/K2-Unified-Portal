...
const StandardHeader = ({ onMenuClick, title = "", onSwitchRole }) => {
        ...
        <div className="flex items-center justify-between">
          ...
          >
            <img
              ...
              className={`h-14 sm:h-16 ${showUnitBranding ? "w-14 sm:w-16 rounded-full object-cover" : "w-auto object-contain"}`}
            />
            <div>
              <h1
                className={`font-semibold text-green-700 ${showUnitBranding ? "text-xl sm:text-2xl" : "text-2xl sm:text-3xl"}`}
              >
                {showUnitBranding
                  ? unitData?.unitName || selectedUnit.unitName
                  : "Krishi Kutumb"}
